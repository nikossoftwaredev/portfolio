export const Logo = () => {
  return (
    ...
    >
      ...
      >
        <path
          d="M905 2049 c-706 -88 -1111 -855 -785 -1488 219 -426 705 -642 1174
   ...
   -244 245 -323 580 -214 910 42 127 108 233 209 335 208 211 491 304 773 255z"
        />
        <path
          d="M459 1321 l-29 -29 0 -247 c0 -215 2 -251 17 -276 16 -26 66 -59 92
   ...
   -154 195 c-103 130 -161 195 -174 195 -10 0 -32 -13 -48 -29z"
        />
        <path
          d="M1114 1332 c-49 -31 -55 -58 -52 -248 l3 -172 34 12 c63 21 76 51 79
